...
config_files = {
    "was_suite_config": {
        "src": "constants/custom_node_configs/was_suite_config.json",
        "dest": os.path.join(custom_nodes_dir, "was-node-suite-comfyui/"),
    },
    "rgthree_config": {
        "src": "constants/custom_node_configs/rgthree_config.json",
        "dest": os.path.join(custom_nodes_dir, "rgthree-comfy/"),
    },
    "comfy_settings": {
        "src": "constants/custom_node_configs/comfy.settings.json",
